...
<x-color><param>#61AFEF</param>(</x-color><x-color><param>#C678DD</param>defconst</x-color> <x-color><param>#E06C75</param>*spell-check-support-enabled*</x-color> nil<x-color><param>#61AFEF</param>)</x-color> ;; <x-color><param>#5C6370</param>Enable with t if you prefer
...
<x-color><param>#61AFEF</param>(</x-color><x-color><param>#C678DD</param>defalias</x-color> '<x-color><param>#61AFEF</param>require-init</x-color>

  <x-color><param>#98C379</param>(</x-color><x-color><param>#C678DD</param>let</x-color> <x-color><param>#D19A66</param>(</x-color><x-color><param>#56B6C2</param>(</x-color>lisp-dir <x-color><param>#C678DD</param>(</x-color>expand-file-name <x-color><param>#98C379</param>"lisp"</x-color> user-emacs-directory<x-color><param>#C678DD</param>)</x-color><x-color><param>#56B6C2</param>)</x-color><x-color><param>#D19A66</param>)</x-color>

	<x-color><param>#D19A66</param>(</x-color><x-color><param>#C678DD</param>lambda</x-color> <x-color><param>#56B6C2</param>(</x-color>pkg <x-color><param>#E5C07B</param>&optional</x-color> maybe-disabled<x-color><param>#56B6C2</param>)</x-color>

	  <x-color><param>#56B6C2</param>(</x-color><x-color><param>#C678DD</param>unless</x-color> maybe-disabled
		<x-color><param>#C678DD</param>(</x-color>load <x-color><param>#E5C07B</param>(</x-color>file-truename <x-color><param>#61AFEF</param>(</x-color>format <x-color><param>#98C379</param>"%s/%s"</x-color> lisp-dir pkg<x-color><param>#61AFEF</param>)</x-color><x-color><param>#E5C07B</param>)</x-color>
			  t t<x-color><param>#C678DD</param>)</x-color><x-color><param>#56B6C2</param>)</x-color><x-color><param>#D19A66</param>)</x-color><x-color><param>#98C379</param>)</x-color>

  "Load PKG if MAYBE-DISABLED is nil or it's nil but start up in normal slowly."<x-color><param>#61AFEF</param>)</x-color>

;; <x-color><param>#5C6370</param>(defun require-init (pkg &optional maybe-disabled)
</x-color>;;   <x-color><param>#5C6370</param>(unless maybe-disabled
</x-color>;;     <x-color><param>#5C6370</param>(load (file-truename (format "%s/%s" inc0n/lisp-dir pkg))
