...
;; <x-color><param>#5C6370</param>@see https://www.reddit.com/r/emacs/comments/3kqt6e/2_easy_little_known_steps_to_speed_up_emacs_start/
  ...
  <x-color><param>#98C379</param>(</x-color>require-init 'init-httpd t<x-color><param>#98C379</param>)</x-color>

  ;; <x-color><param>#5C6370</param>projectile costs 7% startup time
</x-color>
  ...
  <x-color><param>#98C379</param>(</x-color>require-init 'init-emacs-w3m t<x-color><param>#98C379</param>)</x-color>
  <x-color><param>#98C379</param>(</x-color>require-init 'init-shackle t<x-color><param>#98C379</param>)</x-color>
  ...
  <x-color><param>#98C379</param>(</x-color>require-init 'init-hydra<x-color><param>#98C379</param>)</x-color>   ; <x-color><param>#5C6370</param>hotkey is required everywhere
