...
<x-color><param>#61AFEF</param>(</x-color><x-color><param>#C678DD</param>defvar</x-color> <x-color><param>#E06C75</param>normal-gc-cons-threshold</x-color> <x-color><param>#98C379</param>(</x-color>* 36 1024 1024<x-color><param>#98C379</param>)</x-color><x-color><param>#61AFEF</param>)</x-color> ;; <x-color><param>#5C6370</param>36mb
...
</x-color><x-color><param>#61AFEF</param>(</x-color><x-color><param>#C678DD</param>let</x-color> <x-color><param>#98C379</param>(</x-color><x-color><param>#D19A66</param>(</x-color>init-gc-cons-threshold <x-color><param>#56B6C2</param>(</x-color>* 128 1024 1024<x-color><param>#56B6C2</param>)</x-color><x-color><param>#D19A66</param>)</x-color><x-color><param>#98C379</param>)</x-color> ;; <x-color><param>#5C6370</param>128mb
</x-color>  <x-color><param>#98C379</param>(</x-color><x-color><param>#C678DD</param>setq</x-color> garbage-collection-messages t<x-color><param>#98C379</param>)</x-color> ; <x-color><param>#5C6370</param>for debug
  ...
  <x-color><param>#98C379</param>(</x-color><x-color><param>#C678DD</param>setq</x-color> gc-cons-percentage 0.5<x-color><param>#98C379</param>)</x-color><x-color><param>#61AFEF</param>)</x-color>
<x-color><param>#61AFEF</param>(</x-color>add-hook 'emacs-startup-hook
          <x-color><param>#98C379</param>(</x-color><x-color><param>#C678DD</param>lambda</x-color> <x-color><param>#D19A66</param>()</x-color>

            <x-color><param>#D19A66</param>(</x-color><x-color><param>#C678DD</param>setq</x-color> gc-cons-threshold normal-gc-cons-threshold<x-color><param>#D19A66</param>)</x-color>

            <x-color><param>#D19A66</param>(</x-color>message <x-color><param>#98C379</param>"startup time: %s"</x-color> <x-color><param>#56B6C2</param>(</x-color>emacs-init-time<x-color><param>#56B6C2</param>)</x-color><x-color><param>#D19A66</param>)</x-color><x-color><param>#98C379</param>)</x-color><x-color><param>#61AFEF</param>)</x-color>
...
;; <x-color><param>#5C6370</param>@see https://www.reddit.com/r/emacs/comments/3kqt6e/2_easy_little_known_steps_to_speed_up_emacs_start/
  ...
  ;; <x-color><param>#5C6370</param>essential has some crucial tools I need immediately
</x-color>  <x-color><param>#98C379</param>(</x-color>require-init 'init-essential<x-color><param>#98C379</param>)</x-color>
  ;; <x-color><param>#5C6370</param>misc, handy tools though not must have
...
</x-color>  ;; <x-color><param>#5C6370</param>(require-init 'init-shackle)
</x-color>  <x-color><param>#98C379</param>(</x-color>require-init 'init-dired<x-color><param>#98C379</param>)</x-color>
