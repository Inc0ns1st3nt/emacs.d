...
(defface speed-type-normal-face
  '((t (:foreground "gold")))
  "Face for indicating a correct typing character."
  :group 'speed-type)

(defface speed-type-wrong-face
  '((t (:foreground "red")))
  "Face for indicating a wrong typing character."
  :group 'speed-type)

(defvar speed-type-fill-bufferp t
  "Whether the buffer will be fill columned.")

(defvar speed-type-fill-column 70
...
(defun speed-type--handle-del (start end)
  ...
  (cl-loop for pos from start to end
           for q = (aref speed-type--mod-str pos)
           do
           (cond ((= q 0) ())
                 ((= q 1)
...
(defun speed-type--setup (text &optional author title)
  ...
  (when speed-type-fill-bufferp
    (set-fill-column speed-type-fill-column)
